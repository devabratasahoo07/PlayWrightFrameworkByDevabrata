...
export class RegistrationPage extends BasePage
{
    ...
    constructor(page)
    {
        ...
        // add a locator for checkboxes //input[@type='checkbox']
        ...
        // locator for //select[@id='hobbies'] and name it as hobbies
    ...
    // write a method for select interest checkboxes and takes interestValue as parameter
    ...
    {
        const genderOptions = await this.gender.all();
